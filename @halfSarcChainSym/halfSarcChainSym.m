classdef halfSarcChainSym < handle
    ...
    methods
        ...
        function obj = halfSarcChainSym(varargin)
...
%             obj.f = obj.f / (obj.time_step*1000);
            ...
            obj.g(obj.x_bins<0) = obj.g_parameters(1) + ...
                 abs(0.2*((obj.x_bins(obj.x_bins<0)+0).^3));            
            obj.g(obj.x_bins>=0) = obj.g_parameters(1) + ...
                 0.5*((obj.x_bins(obj.x_bins>=0)+0).^3);
            obj.g = obj.g + 3;
