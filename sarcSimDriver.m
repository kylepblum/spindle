...
%                 new_length = max(x,hs.cmd_length);
            ...
            if slack_modeB
               ...
               % First, we evolve the distribution
                hsB.forwardStep(time_step,0.0,0.0,gammaD(a,i),1,0)
               ...
               % Finally, we shift the distribution by the adjusted length
                ...
                hsB.forwardStep(time_step,delta_hslB,delta_cdl(a,i),gammaD(a,i),1,1);
            end
            ...
            if slack_modeC
                ...
                % First, we evolve the distribution
                hsC.forwardStep(time_step,0.0,0.0,gammaS(a,i),1,0)
                ...
                hsC.forwardStep(time_step,delta_hslS,delta_cdl(a,i),gammaS(a,i),1,1);
            end
            
        else %Assume length control
            delta_hslB = delta_cdl(a,i);
            hsB.forwardStep(time_step,delta_hslB,delta_cdl(a,i),gammaD(a,i),1,1);
            delta_hslC = delta_cdl(a,i);
            hsC.forwardStep(time_step,delta_hslC,delta_cdl(a,i),gammaS(a,i),1,1);
        end
