...
time_step = 0.005;  % Temporal precision (slow, but best at ~0.001s; faster but worse at higher steps)
...
%             delta_cdl(a,i) = 118.2*a*lsf*time_step*0.01;
...
[r,rd,rs] = sarc2spindle(dataB(4),dataC(4),1.5,2,0.03,1,0);
figure
hold on;
